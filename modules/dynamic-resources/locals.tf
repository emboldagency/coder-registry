locals {
  ...
  icon = {
    ...
    environment      = "https://api.embold.net/icons/environment.svg"
    folder           = "/icon/folder.svg"
    globe            = "https://api.embold.net/icons/fas-globe.svg"
    mongo            = "https://api.embold.net/icons/mongodb.svg"
    mysql            = "https://api.embold.net/icons/mysql.svg"
    nametag          = "https://api.embold.net/icons/title.svg"
    paperclip        = "https://api.embold.net/icons/fas-link.svg"
    postgres         = "/icons/postgres.svg"
    quantity         = "https://api.embold.net/icons/quantity.svg"
    redis            = "https://api.embold.net/icons/redis.svg"
    share_permission = "https://api.embold.net/icons/fas-user-gear.svg"
    socket           = "https://api.embold.net/icons/fas-plug.svg"
    tag              = "https://api.embold.net/icons/fas-tag.svg"
  }
}
